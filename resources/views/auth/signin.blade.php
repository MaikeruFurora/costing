      ...
      <div class="container container-normal py-4">
        <div class="row align-items-center g-4">
          ...
          @endif
              <div class="card card-md">
                <div class="card-body">
                  ...
                  <form action="{{ route("auth.login.post") }}" method="POST" autocomplete="off" novalidate>@csrf
                    <div class="mb-3">
                      <label class="form-label">Username <sup>OR</sup> Email </label>
                      <input type="email" class="form-control" placeholder="your@email.com" autocomplete="off" name="username">
                    </div>
                    <div class="mb-2">
          ...
          {{-- <div class="col-lg d-none d-lg-block">
            <img src="{{ asset("dist/img/undraw_secure_login_pdn4.svg") }}" height="300" class="d-block mx-auto" alt="">
          </div> --}}
        </div>
      </div>
    </div>
